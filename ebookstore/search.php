...
session_start();
 ...
 $_SESSION['page_location']="search.php";
	...
	<div id="header" class="container-fluid">
		...
		<div class="row "  style="background-color:#fff; padding:30px;" >
			...
			if(isset($_POST['submit']))
			{
				...
				$search_item=trim($_POST['search-item']);
				
				if($search_item=='')
					header("Location:index.php");
				
				echo "<h5><a href=\"index.php\">Home</a> &nbsp; > &nbsp; Search <hr /> </h5>
				
			<h3><font style=\"border-bottom:2px solid red;\">Search result for \"".$search_item."\"</font></h3><br />";
			
			
			$book_info=book_search($search_by,$search_item);
