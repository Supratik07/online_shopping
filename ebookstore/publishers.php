...
$_SESSION['page_location']="publishers.php"; 
	...
	<div id="header" class="container-fluid">
		...
		<div class="row "  style="background-color:#fff; padding:30px;" >
			...
			if(isset($_GET['publisher']))
			{
				...
				$publisher
				<hr /> </h5>
			<h3><font style=\"border-bottom:2px solid red;\">$publisher</font></h3><br />";
			
			$book_info=book_publisher($publisher);
			...
			echo "<h5><a href=\"index.php\">Home</a> &nbsp; > &nbsp; Publishers <hr /> </h5>
			<h3><font style=\"border-bottom:2px solid red;\">Publishers</font></h3><br />";
			$record=publishers();
			if(is_array($record))
			{
				$i=0;
				while($i<count($record))
				{
					...
					for($j=$i;$j<$i+10;$j++)
					{
						...
						echo "<li><a href=\"publishers.php?publisher=".$record[$j]."\">$record[$j]</a></li>";
					}
					echo "</ul></div>";
					$i=$i+10;
