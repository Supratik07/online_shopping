	...
	<div id="header" class="container-fluid">
		...
		<div class="row "  style="background-color:#fff; padding:30px;" >
				...
				<div class="panel panel-primary">
					  ...
					  <div class="panel-heading"><h4>Billing process...</h4></div>
					  <div class="panel-body" >
						<?php
						if(isset($_SESSION['id']))
						{
							$id=$_SESSION['id'];
							$user_info=fetch_profile($id);
							...
							if(is_array($info))
							{
								...
								else
								{
									...
									for($i=0;$i<count($info);$i++)
									{
										...
										</font>	</td><td style='text-align:center;'>".$price."</td></tr>";
									}	
						...
						<form action="billing_process.php" method="post">
						<h4>Shipping Address :</h4>
						<textarea name="address" id="" class="form-control" rows="2" style="resize:none;text-align:left; margin-left:15%;margin-top:-30px; width:20%;" required><?php echo trim($user_info['address']); ?></textarea>
						<br />
						<font style="font-size:18px; font-weight:bold;">Mode of Payment :</font>
						<select name="payment" style="width:15%; padding:5px;">
						...
						<button type="submit" name="place_order" class="btn btn-warning">Place Order</button></center>
						</form>
